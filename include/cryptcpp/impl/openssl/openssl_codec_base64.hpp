...
#ifndef __CRYPTCPP_OPENSSL_CODEC_BASE64_HPP__
#define __CRYPTCPP_OPENSSL_CODEC_BASE64_HPP__
...
class openssl_codec_base64 : public codec {
...
public:
  ...
  //@}
  explicit openssl_codec_base64(codec_algorithm codec_algo)
      : codec(codec_algo) {}
